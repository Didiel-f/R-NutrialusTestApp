            ...
            <div className="card animate__animated animate__bounce">
                ...
                <div className="actions">
                    <div className="follow-info">
                        <h2><a ><span className="material-icons material-icons-round">email</span><small className="animate__animated animate__fadeIn"> {email} </small></a></h2>
                        <h2><a ><span className="material-icons material-icons-round">phone</span><small className="animate__animated animate__fadeIn"> {phone} </small></a></h2>
                    </div>
